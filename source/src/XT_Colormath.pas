...
procedure ColorToXYZ(Color:Integer; var X,Y,Z:Single); Inline;
procedure ColorToLAB(color:Integer; var L,A,B:Single); Inline;
procedure ColorToLCH(Color:Integer; var L,C,H:Single); Inline;
procedure ColorToHSV(Color:Integer; var H,S,V:Single); Inline;
procedure HSVToRGB(H,S,V:Single; var R,G,B:Integer); Inline;
