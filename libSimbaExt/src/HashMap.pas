...
uses
  Classes, CoreTypes, SysUtils, ColorMath;
...
type
  ...
  public
    ...
    function Get(Key: UInt32; var Value: ColorLAB): Boolean;  Inline;
...
function Hash(const k: TBox): UInt32; Inline; overload;
...
//Hash a Single, Double, Extended ..->
function Hash(const k: Single): UInt32; Inline; overload;
begin end;

function Hash(const k: Double): UInt32; Inline; overload;
begin end;



//Hash a TPoint (x,y record)
function Hash(const k: TPoint): UInt32; Inline; overload;
begin
  Result := UInt32((k.y * $0f0f1f1f) xor k.x);
end;

//Hash a TBox (x1,y1,x2,y2 record)
function Hash(const k: TBox): UInt32; Inline; overload;
var a,b:UInt32;
begin
  a := UInt32((k.y1 * $0f0f1f1f) xor k.x1);
  b := UInt32((k.y2 * $0f0f1f1f) xor k.x2);
  Result := (a * $0f0f1f1f) xor b;
end;
...
function TLABHash.Get(Key: UInt32; var Value: ColorLAB): Boolean; Inline;
var
  h,i,l: Int32;
begin
  h := Key and FLen;
