...
function Sqrt(mat: T2DUInt64): T2DDouble; overload; 
var W,H,i,j: Int32; 
begin 
  H := High(mat);
  if (H = -1) then Exit(); 
...
function Sqrt(mat: T2DInt64): T2DDouble; overload; 
var W,H,i,j: Int32; 
begin 
  H := High(mat);
  if (H = -1) then Exit(); 
...
function Sqrt(mat: T2DUInt32): T2DSingle; overload;
var W,H,i,j: Int32; 
begin 
  H := High(mat);
  if (H = -1) then Exit(); 
...
function Sqrt(mat: T2DInt32): T2DSingle; overload; 
var W,H,i,j: Int32; 
begin 
  H := High(mat);
  if (H = -1) then Exit(); 
