...
function MatrixFromTPAEx(const TPA:TPointArray; Init, Value:Integer; Align:Boolean): T2DIntArray;  
begin
  exp_TPAToMatrixEx(TPA,Init,Value,Align, Result);
end;

function MatrixFromTPA(const TPA:TPointArray; Value:Integer; Align:Boolean): T2DIntArray;  
begin
