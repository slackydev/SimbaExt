...
(*
 ...
 > ARCTAN = Extended, Double, Single, Integer, Byte  @                                        ||  Matrix := ArcTan(Matrix)
...
Operator * (l: T2DInt; r: T2DByte): T2DInt;
...
//Int2d / Float2d      || allow-zero divison:
Operator / (l: T2DInt; r: T2DFloat): T2DFloat;
var Wl,Hl,Wr,Hr,i,j: Integer;
begin
  Hl := Length(l);
