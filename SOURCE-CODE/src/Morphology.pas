...
function TPASkeleton(const TPA:TPointArray; FMin,FMax:Integer): TPointArray;
function TPAExpand(const TPA:TPointArray; Iterations:Integer): TPointArray;
function TPAReduce(const TPA:TPointArray; FMin,FMax, Iterations:Integer): TPointArray;


//--------------------------------------------------
implementation
uses 
  PointList, PointTools;
